...
engage the kill switch again. Add scheduling only after a verified pilot and an explicit scheduling decision;
never run competing schedulers for the same account/outbox.
